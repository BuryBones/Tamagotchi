...
public class ControlsPanel extends JPanel {
    ...
    private JButton goLeft = new JButton(new ImageIcon(new BufferedImageLoader().loadImage("images/icons/left.png").getScaledInstance(32,32,Image.SCALE_SMOOTH)));
    private JButton goRight = new JButton(new ImageIcon(new BufferedImageLoader().loadImage("images/icons/right.png").getScaledInstance(32,32,Image.SCALE_SMOOTH)));
    ...
    private void setActions() {
        ...
        exit.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke(27, 0), "exit");
        ...
        goRight.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke(39, 0), "right");
        ...
        goLeft.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke(37, 0), "left");
